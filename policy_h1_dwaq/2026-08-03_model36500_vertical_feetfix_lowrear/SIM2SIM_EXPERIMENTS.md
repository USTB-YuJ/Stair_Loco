...
- Sim2sim: `vx=0.6 m/s`, vertical payload, 1 cm nose stair scene. The robot
  ...
  1.15 m.
- User-preferred camera restored for future recordings: direct rear
  (`yaw=180°`), elevation -15°, look-at height 0.75 m, and distance 4.0 m so
  the whole robot remains in frame. Recording was 10.08 s at 12 fps.
- Video:
