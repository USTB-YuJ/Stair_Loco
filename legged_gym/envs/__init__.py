...
from legged_gym.envs.h1_loco.h1_loco_config import H1_Loco_Cfg, H1_Loco_CfgPPO
from legged_gym.envs.h1_loco.h1_loco_env import H1_Loco_Robot
task_registry.register("h1_loco", H1_Loco_Robot, H1_Loco_Cfg(), H1_Loco_CfgPPO())
