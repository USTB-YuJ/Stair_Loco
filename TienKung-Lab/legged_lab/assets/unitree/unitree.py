...
# Vertical back-mounted extinguisher matching the real H1 installation.
H1_PAYLOAD_VERTICAL_CFG = H1_CFG.replace(
    spawn=sim_utils.UrdfFileCfg(
        asset_path=f"{ISAAC_ASSET_DIR}/h1_description/urdf/h1_payload_vertical.urdf",
        usd_dir=f"{ISAAC_ASSET_DIR}/unitree/h1_payload_vertical",
        usd_file_name="h1_payload_vertical.usd",
        fix_base=False,
        merge_fixed_joints=False,
        self_collision=True,
        replace_cylinders_with_capsules=False,
